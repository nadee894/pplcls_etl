 ...
 * @author Gaya
 */
public class ApparelEmployeeAttributeMapperPanel extends javax.swing.JPanel {
     ...
     */
    public ApparelEmployeeAttributeMapperPanel() {
        initComponents();
    }

    public ApparelEmployeeAttributeMapperPanel(String data, EmployeeDataExtractPanel employeeDataExtractPanel) {
        initComponents();
...
//            System.out.println(attributes[i]);
            ...
            cb_status.addItem(attributes[i]);
...
//    
    public String setHeader() {
        ...
        mappedAttributes[status] = "status";
