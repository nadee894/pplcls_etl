 ...
 * @author Gaya
 */
public class ProjectRawDataView extends javax.swing.JDialog {

    /**
     * Creates new form EmployeeRawDataView
     */
    public ProjectRawDataView(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        center();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProjectRawDataView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProjectRawDataView dialog = new ProjectRawDataView(new javax.swing.JFrame(), true);
